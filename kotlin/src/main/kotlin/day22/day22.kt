...
private fun sanityTests() {
    ...
    check(Area3D(5..10, 5..10, 5..10).extractXAxisSlice((0..0)) == null to listOf(Area3D(5..10, 5..10, 5..10)))
    check(
    ...
    check(Area3D(5..10, 5..10, 5..10).extractYAxisSlice((0..0)) == null to listOf(Area3D(5..10, 5..10, 5..10)))
    check(
    ...
    check(Area3D(5..10, 5..10, 5..10).extractZAxisSlice((0..0)) == null to listOf(Area3D(5..10, 5..10, 5..10)))
    check(
